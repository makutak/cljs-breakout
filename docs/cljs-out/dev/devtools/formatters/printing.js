...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30703){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30709_SHARP_){
return (!((cljs.core.meta.call(null,p1__30709_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__30710__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30714){var _e__30334__auto__ = e30714;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e30716){var _e__30334__auto__ = e30716;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30718 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30719 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30719);

try{var map__30720 = opts;
...
var markup_db = cljs.core.get.call(null,map__30720__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30718);
}});
...
var temp__5718__auto___30725 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___30725)){
var managed_print_level_30726 = temp__5718__auto___30725;
var _STAR_print_level_STAR__orig_val__30723_30727 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30724_30728 = managed_print_level_30726;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30724_30728);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__30722_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30722_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30723_30727);
}} else {
job_fn.call(null);
}
