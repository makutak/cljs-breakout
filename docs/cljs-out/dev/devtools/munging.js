...
var o30572 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30572["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30573 = temp__5718__auto____$1;
return (o30573["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30327__auto__ = f;
return (o__30327__auto__["toString"]).call(o__30327__auto__);
} else {
return "";
}
}catch (e30574){var _ = e30574;
return "";
}});
...
try{var o__30327__auto___30576 = t;
(o__30327__auto___30576["cljs$lang$ctorPrWriter"]).call(o__30327__auto___30576,t,writer);
}catch (e30575){var __30577 = e30575;
}
...
var char_code = (function (){var o__30327__auto__ = (new String(char$));
return (o__30327__auto__["charCodeAt"]).call(o__30327__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30327__auto__ = String;
return (o__30327__auto__["fromCharCode"]).call(o__30327__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30578 = num_code;
switch (G__30578) {
case (1):
return (185);
...
var o__30327__auto__ = String;
return (o__30327__auto__["fromCharCode"]).call(o__30327__auto__,superscript_code);
});
/**
...
}catch (e30580){var _e__30334__auto__ = e30580;
return false;
}})())){
...
var vec__30581 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30581,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o30584 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30584["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30585 = temp__5718__auto____$1;
return (o30585["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___30592 = arguments.length;
var i__4737__auto___30593 = (0);
while(true){
if((i__4737__auto___30593 < len__4736__auto___30592)){
args__4742__auto__.push((arguments[i__4737__auto___30593]));

var G__30594 = (i__4737__auto___30593 + (1));
i__4737__auto___30593 = G__30594;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30588){
var vec__30589 = p__30588;
var ns_detector = cljs.core.nth.call(null,vec__30589,(0),null);
...
var G__30595 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30596 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30595;
remaining_tokens = G__30596;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30586){
var G__30587 = cljs.core.first.call(null,seq30586);
var seq30586__$1 = cljs.core.next.call(null,seq30586);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30587,seq30586__$1);
}));
...
var vec__30600 = cljs.core.split_with.call(null,(function (p1__30599_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30599_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30600,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30600,(1),null);
...
var vec__30606 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30606,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30606,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30609 = cljs.core.rest.call(null,remaining_tokens);
var G__30610 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30609;
name_tokens = G__30610;
continue;
} else {
...
var vec__30613 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30613,(0),null);
var arity = cljs.core.nth.call(null,vec__30613,(1),null);
var vec__30616 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30616,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30616,(1),null);
var vec__30619 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30619,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30619,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30619,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30619,(3),null);
...
var vec__30625 = result;
var munged_ns = cljs.core.nth.call(null,vec__30625,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30625,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30625,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30625,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30625,(4),null);
var arity = cljs.core.nth.call(null,vec__30625,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__30629 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__30629,(0),null);
var args = cljs.core.nth.call(null,vec__30629,(1),null);
var vec__30632 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30632,(0),null);
var name = cljs.core.nth.call(null,vec__30632,(1),null);
...
var G__30635 = (arity + (1));
var G__30636 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30637){
var vec__30638 = p__30637;
var arity = cljs.core.nth.call(null,vec__30638,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30638,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30641_SHARP_){
return cljs.core.get.call(null,arities,p1__30641_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__30642_SHARP_){
return cljs.core.drop.call(null,(2),p1__30642_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30645){
var vec__30646 = p__30645;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30646,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30643){
var G__30644 = cljs.core.first.call(null,seq30643);
var seq30643__$1 = cljs.core.next.call(null,seq30643);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30644,seq30643__$1);
}));
...
var G__30652 = arg;
var G__30652__$1 = (((G__30652 instanceof cljs.core.Keyword))?G__30652.fqn:null);
switch (G__30652__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30654__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30654__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30654__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30654__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30655 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30655,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30655,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30655,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30655,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30655,(4),null);
var arity = cljs.core.nth.call(null,vec__30655,(5),null);
...
var o__30327__auto__ = f;
return (o__30327__auto__["getBasis"]).call(o__30327__auto__);
});
/**
...
}catch (e30659){var _e__30334__auto__ = e30659;
...
var G__30660 = (obj[cljs.core.first.call(null,path)]);
var G__30661 = cljs.core.rest.call(null,path);
obj = G__30660;
path = G__30661;
continue;
} else {
...
var _STAR_ = (function (accum,p__30662){
var vec__30663 = p__30662;
var bit = cljs.core.nth.call(null,vec__30663,(0),null);
var protocol = cljs.core.nth.call(null,vec__30663,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30666){
var vec__30667 = p__30666;
var ns = cljs.core.nth.call(null,vec__30667,(0),null);
var name = cljs.core.nth.call(null,vec__30667,(1),null);
var selector = cljs.core.nth.call(null,vec__30667,(2),null);
...
var post_process = (function (p__30671){
var vec__30672 = p__30671;
var munged_name = cljs.core.nth.call(null,vec__30672,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30672,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30670_SHARP_){
return (obj[cljs.core.first.call(null,p1__30670_SHARP_)]);
}),sorted_matches);
